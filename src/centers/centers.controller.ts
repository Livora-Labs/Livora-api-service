...
export class CentersController {
  ...
  @ApiOperation({ summary: 'Obtener PIN de recepción actual (Rol: CENTRO_ACOPIO / ALMACEN)' })
  ...
  @Roles(Role.CENTRO_ACOPIO, Role.ALMACEN)
  @ApiOperation({ summary: 'Regenerar nuevo PIN de recepción (Rol: CENTRO_ACOPIO / ALMACEN)' })
  ...
  @ApiOperation({ summary: 'Listar todos los Centros (Rol: RECOLECTOR / CENTRO_ACOPIO / ALMACEN / ADMIN)' })
  @ApiResponse({ status: 200, description: 'Lista de centros devuelta exitosamente' })
  async findAll() {
