...
export class MetricsController {
  ...
  @Roles(Role.HOGAR)
  @ApiOperation({ summary: 'Obtener métricas de reciclaje del hogar autenticado (Rol: HOGAR)' })
  ...
  @ApiOperation({ summary: 'Obtener reputación y score del recolector (Rol: RECOLECTOR)' })
  ...
  @ApiOperation({ summary: 'Obtener métricas de impacto ambiental ESG (Rol: EMPRESA_B2B)' })
  ...
  @Get('admin/metrics')
  @Roles(Role.ADMIN)
  @ApiOperation({ summary: 'Obtener métricas globales de la plataforma (Rol: ADMIN)' })
